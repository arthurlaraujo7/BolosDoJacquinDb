...
{
    private readonly ICategorias _service;

    public CategoriasController(ICategorias service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CategoriasDTO dto)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] CategoriasDTO dto)
    {
